...
const projects = [
    { name: 'Bug Tracking System', domain:'AI', description: 'AI model for diagnosing diseases', algorithms: 'Deep Learning, Neural Networks', researchPaper: 'https://www.dropbox.com/scl/fi/gmknbfwrut3ekomnjhted/21.Bug-Tracking-System.docx?rlkey=zc89g7nguxbxtuf7rql6s6rs5&st=khb4z6li&dl=1' },
    { name: 'File Storage System using hybrid crptographic',domain:'AI,', description: 'Traffic management with IoT and AI', algorithms: 'IoT, Machine Learning, Data Analytics', researchPaper: 'https://www.dropbox.com/scl/fi/xgosql98m06mgicsawe0p/22.File-Storage-System-Using-Hybrid-Cryptography.docx?rlkey=b1778jsr3tdyei57ouwpnquxj&st=ubkzd4kr&dl=1' },
    { name: 'E-learning', domain:'AI', description: 'Traffic management with IoT and AI', algorithms: 'IoT, Machine Learning, Data Analytics', researchPaper: 'https://www.dropbox.com/scl/fi/1ltkf5mf86e2pzxgdt3qv/25.E-learning.docx?rlkey=9drp7h861tponlcczi5gtmnyw&st=pxkv6mq0&dl=1' },
    { name: 'online BookStore', domain:'AI',description: 'Traffic management with IoT and AI', algorithms: 'IoT, Machine Learning, Data Analytics', researchPaper: 'https://www.dropbox.com/scl/fi/792x96x3mdzodo2qs33my/26.Online-Bookstore.docx?rlkey=w0ojql7r65r464radzyasl1eq&st=rantcecy&dl=1' },
    { name: 'Information Chatbot',domain:'dsa' ,description: 'Traffic management with IoT and AI', algorithms: 'IoT, Machine Learning, Data Analytics', researchPaper: 'https://www.dropbox.com/scl/fi/4l2mijjtqvze6beluvy45/27.Information-Chatbot.docx?rlkey=ejy3l9mvcyulvb5l47pff6ydi&st=a7sqhaka&dl=1' },
    { name: 'Online Blood Bank System', domain:'dsa', description: 'Traffic management with IoT and AI', algorithms: 'IoT, Machine Learning, Data Analytics', researchPaper: 'https://www.dropbox.com/scl/fi/ekkeci1w1oy0g3vgoblk9/28.Online-Blood-Bank-System.docx?rlkey=zmze05uciokg6zj8b9fdq50m9&st=0rpw1m63&dl=1' },
